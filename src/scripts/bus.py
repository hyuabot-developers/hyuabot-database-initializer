...
async def insert_bus_route_stop(db_session: Session):
    bus_route_stop_list = [
        dict(route_id="216000026", stop_id="216000719", stop_sequence=12, start_stop_id=217000292),  # 3100(한양대정문)
        dict(route_id="216000096", stop_id="216000719", stop_sequence=12, start_stop_id=217000292),  # 3100N(한양대정문)
        dict(route_id="216000043", stop_id="216000719", stop_sequence=12, start_stop_id=217000292),  # 3101(한양대정문)
        dict(route_id="216000070", stop_id="216000719", stop_sequence=14, start_stop_id=217000283),  # 707-1(한양대정문)
        ...
        dict(route_id="216000068", stop_id="216000383", stop_sequence=12, start_stop_id=216000358),  # 10-1(한양대기숙사앞)
        dict(route_id="216000068", stop_id="216000381", stop_sequence=13, start_stop_id=216000358),  # 10-1(한국생산기술연구원)
        dict(route_id="216000068", stop_id="216000379", stop_sequence=14, start_stop_id=216000358),  # 10-1(ERICA컨벤션센터)
        dict(route_id="216000068", stop_id="216000138", stop_sequence=21, start_stop_id=216000138),  # 10-1(상록수역3번출구)
